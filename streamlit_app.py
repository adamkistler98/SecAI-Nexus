...
costs = [[("US Average",f"color:{CYAN};font-weight:bold;"),("$10.22M",f"color:{RED};font-weight:bold;font-size:.58rem;"),("All-time high (+9%)",f"color:#888;font-size:.56rem;")],[("Healthcare",f"color:{CYAN};font-weight:bold;"),("$7.42M",f"color:{RED};font-weight:bold;font-size:.58rem;"),("#1 for 15 yrs",f"color:#888;font-size:.56rem;")],[("Financial",f"color:{CYAN};font-weight:bold;"),("$5.56M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("BEC heavy",f"color:#888;font-size:.56rem;")],[("Industrial / Mfg",f"color:{CYAN};font-weight:bold;"),("$5.00M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("OT risks & IP theft",f"color:#888;font-size:.56rem;")],[("Technology",f"color:{CYAN};font-weight:bold;"),("$5.15M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("Supply chain",f"color:#888;font-size:.56rem;")],[("Energy",f"color:{CYAN};font-weight:bold;"),("$4.89M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("Grid attacks",f"color:#888;font-size:.56rem;")],[("Pharma",f"color:{CYAN};font-weight:bold;"),("$4.97M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("IP theft",f"color:#888;font-size:.56rem;")],[("Global Average",f"color:{CYAN};font-weight:bold;"),("$4.44M",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("Down 9% YoY globally",f"color:#888;font-size:.56rem;")],[("Government",f"color:{CYAN};font-weight:bold;"),("$4.43M",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("APT targets",f"color:#888;font-size:.56rem;")],[("Retail",f"color:{CYAN};font-weight:bold;"),("$3.54M",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("Ransomware surge",f"color:#888;font-size:.56rem;")]]
...
ai_crime = [[("AI Phishing",f"color:{CYAN};font-weight:bold;"),("Scaling Fast",f"color:{RED};font-weight:bold;"),("Hyper-personalized at scale",f"color:#888;font-size:.56rem;")],[("Deepfakes/Vishing",f"color:{CYAN};font-weight:bold;"),("442% ↑",f"color:{RED};font-weight:bold;"),("Voice/video scams",f"color:#888;font-size:.56rem;")],[("Polymorphic Malware",f"color:{CYAN};font-weight:bold;"),("Evasive",f"color:{RED};font-weight:bold;"),("AI mutates code",f"color:#888;font-size:.56rem;")],[("Prompt Injection",f"color:{CYAN};font-weight:bold;"),("Front-Page",f"color:{RED};font-weight:bold;"),("Bypass AI safeguards",f"color:#888;font-size:.56rem;")],[("AI Recon/OSINT",f"color:{CYAN};font-weight:bold;"),("Automated",f"color:{AMBER};font-weight:bold;"),("Target profiling",f"color:#888;font-size:.56rem;")],[("Agentic AI Abuse",f"color:{CYAN};font-weight:bold;"),("Insider Risk",f"color:{AMBER};font-weight:bold;"),("Unintended actions",f"color:#888;font-size:.56rem;")],[("Model Poisoning",f"color:{CYAN};font-weight:bold;"),("Supply Chain",f"color:{AMBER};font-weight:bold;"),("Backdoors in AI",f"color:#888;font-size:.56rem;")],[("Deepfake Fraud",f"color:{CYAN};font-weight:bold;"),("Rising",f"color:{AMBER};font-weight:bold;"),("Impersonation attacks",f"color:#888;font-size:.56rem;")],[("Automated Triage Evasion",f"color:{CYAN};font-weight:bold;"),("Emerging",f"color:{AMBER};font-weight:bold;"),("Tricking SOC AI tools",f"color:#888;font-size:.56rem;")],[("AI Pass Cracking",f"color:{CYAN};font-weight:bold;"),("PassGAN",f"color:{RED};font-weight:bold;"),("Predictive cracking",f"color:#888;font-size:.56rem;")]]

# ─── ROW 1: AI (Models & Risks)
g1, g2 = st.columns(2)
with g1: st.markdown(_tbl("🤖 TOP 10 AI MODELS & CAPABILITIES (2026)", ["Rank & Model", "Top Use Case", "Best For", "Description", "Top Vuln"], ai_rows, CYAN), unsafe_allow_html=True)
with g2: st.markdown(_tbl("🛡 OWASP LLM TOP 10 (v1.1)", ["#", "Vulnerability", "Description", ""], owasp_llm, CYAN), unsafe_allow_html=True)

# ─── ROW 2: Threat Context (AI Cybercrime & Attack Techniques)
g3, g4 = st.columns(2)
with g3: st.markdown(_tbl("🤖 AI-POWERED CYBERCRIME (2026)", ["Attack", "Status", "Details"], ai_crime, CYAN), unsafe_allow_html=True)
with g4: st.markdown(_tbl("⚔ MITRE ATT&CK TOP TECHNIQUES (2026)", ["ID", "Technique", "Tactic", "Freq", "Sev"], attck, BLUE), unsafe_allow_html=True)

# ─── ROW 3: Vulnerabilities (CISA KEV & Top CVEs)
g5, g6 = st.columns(2)
with g5: 
    if kev_rows:
...
with g6: st.markdown(_tbl("🔥 TOP EXPLOITED CVEs 2026", ["CVE", "Product", "CVSS", "Impact"], topcves, RED), unsafe_allow_html=True)

# ─── ROW 4: Threat Actors (Ransomware & APTs)
g7, g8 = st.columns(2)
with g7: st.markdown(_tbl("💀 TOP RANSOMWARE GROUPS 2026", ["Group", "Share", "Victims", "Status", "Intel"], rwg, RED), unsafe_allow_html=True)
with g8: st.markdown(_tbl("🌐 NATION-STATE APT GROUPS 2026", ["Group", "", "Focus", "Intel"], apts, AMBER), unsafe_allow_html=True)

# ─── ROW 5: Costs & Vectors (IBM 2025/26)
g9, g10 = st.columns(2)
