...
with top_tables_c1:
    ai_models = [
        ("1. Gemini 3 Pro", "https://gemini.google.com/", "Multimodal Reasoning", "Complex tasks & integration", "Google's flagship with 1M+ context & superior multimodal", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/01_prompt_injection" target="_blank" style="color:#ff4b4b;">Prompt Injection (LLM01)</a>'),
        ("2. Claude Opus 4.6", "https://claude.ai/", "Advanced Coding & Writing", "Safety & long-form content", "Anthropic's top model excelling in reasoning & ethics", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/02_insecure_output" target="_blank" style="color:#ff4b4b;">Insecure Output (LLM02)</a>'),
        ("3. GPT-5.2", "https://chatgpt.com/", "General Intelligence", "Versatile & research", "OpenAI's latest with enhanced agentic capabilities", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/05_supply_chain" target="_blank" style="color:#ff4b4b;">Supply Chain (LLM05)</a>'),
        ("4. Grok 4.20", "https://x.ai/", "Real-time & Uncensored", "Humor & current events", "xAI's innovative four-agent architecture model", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/08_excessive_agency" target="_blank" style="color:#ff4b4b;">Excessive Agency (LLM08)</a>'),
        ("5. Llama 4 Scout", "https://llama.meta.com/", "Open Weights", "Local deploy & efficiency", "Meta's open-source leader with 10M token context", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/05_supply_chain" target="_blank" style="color:#ff4b4b;">Supply Chain (LLM05)</a>'),
        ("6. DeepSeek V3.2", "https://deepseek.com/", "Math & Coding", "High-precision tasks", "Open-source performer in technical domains", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/03_training_data_poisoning" target="_blank" style="color:#ff4b4b;">Training Data Poisoning (LLM03)</a>'),
        ("7. Kimi K2 Thinking", "https://kimi.moonshot.cn/", "Multilingual Reasoning", "Enterprise & search", "Moonshot's advanced model with strong benchmarks", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/06_sensitive_info_disclosure" target="_blank" style="color:#ff4b4b;">Information Disclosure (LLM06)</a>'),
        ("8. Qwen 3.5 Max", "https://qwen.ai/", "Multilingual & Efficient", "Business workflows", "Alibaba's top open-source multilingual model", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/07_insecure_plugin_design" target="_blank" style="color:#ff4b4b;">Insecure Plugin (LLM07)</a>'),
        ("9. Mistral Large 3", "https://mistral.ai/", "Enterprise & Multi-lingual", "Efficient inference", "Leading European AI for global business", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/01_prompt_injection" target="_blank" style="color:#ff4b4b;">Prompt Injection (LLM01)</a>'),
        ("10. Perplexity Pro", "https://www.perplexity.ai/", "Search & Research", "Real-time citations", "AI-powered search with live web access", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/04_model_dos" target="_blank" style="color:#ff4b4b;">Model DoS (LLM04)</a>'),
        ("11. Cohere Command R+", "https://cohere.com/", "Enterprise RAG", "Secure workflows", "Cohere's enterprise-focused retrieval model", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/02_insecure_output" target="_blank" style="color:#ff4b4b;">Insecure Output (LLM02)</a>'),
        ("12. GLM-5", "https://zhipuai.cn/", "Multimodal", "Chinese/English tasks", "Zhipu's latest multimodal powerhouse", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/05_supply_chain" target="_blank" style="color:#ff4b4b;">Supply Chain (LLM05)</a>'),
        ("13. Phi-4", "https://azure.microsoft.com/", "Lightweight & Edge", "On-device AI", "Microsoft's efficient small model series", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/03_training_data_poisoning" target="_blank" style="color:#ff4b4b;">Training Data Poisoning (LLM03)</a>'),
        ("14. ByteDance Seed 2.0", "https://bytedance.com/", "Creative & Generation", "Content creation", "ByteDance's advanced generative model", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/07_insecure_plugin_design" target="_blank" style="color:#ff4b4b;">Insecure Plugin (LLM07)</a>'),
        ("15. MiniMax M2.5", "https://minimax.cn/", "Compact & Fast", "Mobile/edge deploy", "Efficient model for resource-constrained environments", '<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/06_sensitive_info_disclosure" target="_blank" style="color:#ff4b4b;">Information Disclosure (LLM06)</a>'),
    ]
...
vectors = [[("Phishing",f"color:{CYAN};font-weight:bold;"),("16%",f"color:{RED};font-weight:bold;font-size:.58rem;"),("#1 initial access",f"color:#888;font-size:.56rem;")],[("Supply Chain",f"color:{CYAN};font-weight:bold;"),("15%",f"color:{RED};font-weight:bold;font-size:.58rem;"),("#2 vector",f"color:#888;font-size:.56rem;")],[("DoS",f"color:{CYAN};font-weight:bold;"),("13%",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("#3 attack",f"color:#888;font-size:.56rem;")],[("Stolen Credentials",f"color:{CYAN};font-weight:bold;"),("12%",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("Dark web sales",f"color:#888;font-size:.56rem;")],[("BEC",f"color:{CYAN};font-weight:bold;"),("9%",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("Wire fraud",f"color:#888;font-size:.56rem;")],[("Malicious Insider",f"color:{CYAN};font-weight:bold;"),("$4.92M",f"color:{RED};font-weight:bold;font-size:.58rem;"),("Costliest",f"color:#888;font-size:.56rem;")],[("Human Error",f"color:{CYAN};font-weight:bold;"),("26%",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("Non-malicious",f"color:#888;font-size:.56rem;")],[("IT Failure",f"color:{CYAN};font-weight:bold;"),("23%",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("System issues",f"color:#888;font-size:.56rem;")]]
topcves = [[("CVE-2025-55182",f"color:{CYAN};font-weight:bold;"),("React2Shell",f"color:#888;font-size:.56rem;"),("10.0",f"color:{RED};font-weight:bold;"),("Unauth RCE",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-66516",f"color:{CYAN};font-weight:bold;"),("Apache Tika",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("XXE/SSRF",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-52691",f"color:{CYAN};font-weight:bold;"),("SmarterMail",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("File Upload RCE",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-6204",f"color:{CYAN};font-weight:bold;"),("DELMIA Apriso",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("Code Injection",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-54236",f"color:{CYAN};font-weight:bold;"),("Adobe Commerce",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("Input Validation",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-59287",f"color:{CYAN};font-weight:bold;"),("Windows WSUS",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("Deserialization",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-61932",f"color:{CYAN};font-weight:bold;"),("Motex LANSCOPE",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("Channel Verification",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-33073",f"color:{CYAN};font-weight:bold;"),("Windows SMB",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("Access Control",f"color:{GREY};font-size:.56rem;")]]
costs = [[("Healthcare",f"color:{CYAN};font-weight:bold;"),("$7.42M",f"color:{RED};font-weight:bold;font-size:.58rem;"),("#1 for 15 yrs",f"color:#888;font-size:.56rem;")],[("Financial",f"color:{CYAN};font-weight:bold;"),("$5.68M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("BEC heavy",f"color:#888;font-size:.56rem;")],[("Industrial",f"color:{CYAN};font-weight:bold;"),("$5.56M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("OT risks",f"color:#888;font-size:.56rem;")],[("Technology",f"color:{CYAN};font-weight:bold;"),("$5.15M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("Supply chain",f"color:#888;font-size:.56rem;")],[("Energy",f"color:{CYAN};font-weight:bold;"),("$4.89M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("Grid attacks",f"color:#888;font-size:.56rem;")],[("Pharma",f"color:{CYAN};font-weight:bold;"),("$4.97M",f"color:{AMBER};font-weight:bold;font-size:.58rem;"),("IP theft",f"color:#888;font-size:.56rem;")],[("Government",f"color:{CYAN};font-weight:bold;"),("$4.43M",f"color:{BLUE};font-weight:bold;font-size:.58rem;"),("APT targets",f"color:#888;font-size:.56rem;")],[("US Average",f"color:{CYAN};font-weight:bold;"),("$10.22M",f"color:{RED};font-weight:bold;font-size:.58rem;"),("All-time high",f"color:#888;font-size:.56rem;")]]
owasp_llm = [[("LLM01",f"color:{RED};font-weight:bold;"),("Prompt Injection",f"color:{CYAN};font-weight:bold;"),("Craft input to bypass/exfil",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],[("LLM02",f"color:{RED};font-weight:bold;"),("Insecure Output Handling",f"color:{CYAN};font-weight:bold;"),("Unsanitized output → XSS/RCE",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],[("LLM03",f"color:{AMBER};font-weight:bold;"),("Training Data Poisoning",f"color:{CYAN};font-weight:bold;"),("Corrupt data → backdoors",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],[("LLM04",f"color:{AMBER};font-weight:bold;"),("Model Denial of Service",f"color:{CYAN};font-weight:bold;"),("Resource exhaust",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],[("LLM05",f"color:{RED};font-weight:bold;"),("Supply Chain Vulnerabilities",f"color:{CYAN};font-weight:bold;"),("Compromised components",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],[("LLM06",f"color:{RED};font-weight:bold;"),("Sensitive Info Disclosure",f"color:{CYAN};font-weight:bold;"),("Leaks PII/creds",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],[("LLM07",f"color:{AMBER};font-weight:bold;"),("Insecure Plugin Design",f"color:{CYAN};font-weight:bold;"),("Excess perms/validation",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],[("LLM08",f"color:{AMBER};font-weight:bold;"),("Excessive Agency",f"color:{CYAN};font-weight:bold;"),("Over-permissioned agents",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],[("LLM09",f"color:{AMBER};font-weight:bold;"),("Overreliance",f"color:{CYAN};font-weight:bold;"),("Blind trust in output",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],[("LLM10",f"color:{AMBER};font-weight:bold;"),("Model Theft",f"color:{CYAN};font-weight:bold;"),("Steal weights/IP",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")]]
ai_crime = [[("AI Phishing",f"color:{CYAN};font-weight:bold;"),("Scaling Fast",f"color:{RED};font-weight:bold;"),("Hyper-personalized at scale",f"color:#888;font-size:.56rem;")],[("Deepfakes/Vishing",f"color:{CYAN};font-weight:bold;"),("442% ↑",f"color:{RED};font-weight:bold;"),("Voice/video scams",f"color:#888;font-size:.56rem;")],[("Polymorphic Malware",f"color:{CYAN};font-weight:bold;"),("Evasive",f"color:{RED};font-weight:bold;"),("AI mutates code",f"color:#888;font-size:.56rem;")],[("Prompt Injection",f"color:{CYAN};font-weight:bold;"),("Front-Page",f"color:{RED};font-weight:bold;"),("Bypass AI safeguards",f"color:#888;font-size:.56rem;")],[("AI Recon/OSINT",f"color:{CYAN};font-weight:bold;"),("Automated",f"color:{AMBER};font-weight:bold;"),("Target profiling",f"color:#888;font-size:.56rem;")],[("Agentic AI Abuse",f"color:{CYAN};font-weight:bold;"),("Insider Risk",f"color:{AMBER};font-weight:bold;"),("Unintended actions",f"color:#888;font-size:.56rem;")],[("Model Poisoning",f"color:{CYAN};font-weight:bold;"),("Supply Chain",f"color:{AMBER};font-weight:bold;"),("Backdoors in AI",f"color:#888;font-size:.56rem;")],[("Deepfake Fraud",f"color:{CYAN};font-weight:bold;"),("Rising",f"color:{AMBER};font-weight:bold;"),("Impersonation attacks",f"color:#888;font-size:.56rem;")]]
...
g5,g6=st.columns(2)
with g5: st.markdown(_tbl("🔥 TOP EXPLOITED CVEs 2025",["CVE","Product","CVSS","Impact"],topcves,RED),unsafe_allow_html=True)
with g6: st.markdown(_tbl("💰 BREACH COST BY INDUSTRY (IBM 2025)",["Industry","Avg Cost","Detail"],costs,GREEN),unsafe_allow_html=True)
g7,g8=st.columns(2)
with g7: st.markdown(_tbl("🛡 OWASP LLM TOP 10 (v1.1)",["#","Vulnerability","Description",""],owasp_llm,CYAN),unsafe_allow_html=True)
