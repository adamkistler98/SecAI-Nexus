...
# ── TOP 15 AI MODELS (already updated from previous paste, but included here for completeness) ──
with top_tables_c1:
    ai_models = [
...
# ── UPDATED REFERENCE TABLES (numbered internally + updated titles + 15-row CVE) ──
g1,g2=st.columns(2)
...
with g8: st.markdown(_tbl("AI-POWERED CYBERCRIME (Last updated March 9, 2026)",["Rank","Attack","Status","Details"],[[("1","Deepfake Vishing",f"color:{CYAN};font-weight:bold;"),("442% ↑",f"color:{RED};font-weight:bold;"),("3-sec voice clone for BEC wire fraud",f"color:#888;font-size:.56rem;")],[("2","LLM Phishing
