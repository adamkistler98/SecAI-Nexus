...
owasp_llm = [
    [("LLM01",f"color:{RED};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/01_prompt_injection" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Prompt Injection</a>',f"color:{CYAN};font-weight:bold;"),("Craft input to bypass safety/exfil data",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],
    [("LLM02",f"color:{RED};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/02_insecure_output" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Insecure Output</a>',f"color:{CYAN};font-weight:bold;"),("Unsanitized LLM output → XSS/SQLi/RCE",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],
    [("LLM03",f"color:{AMBER};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/03_training_data_poisoning" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Training Data Poisoning</a>',f"color:{CYAN};font-weight:bold;"),("Corrupted data → backdoors/bias",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],
    [("LLM04",f"color:{AMBER};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/04_model_dos" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Model DoS</a>',f"color:{CYAN};font-weight:bold;"),("Resource exhaust via complex prompts",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],
    [("LLM05",f"color:{RED};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/05_supply_chain" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Supply Chain Vulnerabilities</a>',f"color:{CYAN};font-weight:bold;"),("Compromised weights/plugins/pipelines",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],
    [("LLM06",f"color:{RED};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/06_sensitive_info_disclosure" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Sensitive Information Disclosure</a>',f"color:{CYAN};font-weight:bold;"),("LLM leaks PII/creds in responses",f"color:#888;font-size:.56rem;"),("🔴",f"text-align:center;")],
    [("LLM07",f"color:{AMBER};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/07_insecure_plugin_design" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Insecure Plugin Design</a>',f"color:{CYAN};font-weight:bold;"),("Excessive perms, no input validation",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],
    [("LLM08",f"color:{AMBER};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/08_excessive_agency" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Excessive Agency</a>',f"color:{CYAN};font-weight:bold;"),("Agents w/too many perms, autonomous",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],
    [("LLM09",f"color:{AMBER};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/09_overreliance" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Overreliance</a>',f"color:{CYAN};font-weight:bold;"),("Blind trust in LLM output → errors/risks",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],
    [("LLM10",f"color:{AMBER};font-weight:bold;"),('<a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/descriptions/10_model_theft" target="_blank" style="color:{CYAN};text-decoration:none;border-bottom:1px dashed {CYAN}40;">Model Theft</a>',f"color:{CYAN};font-weight:bold;"),("Steal model weights/IP",f"color:#888;font-size:.56rem;"),("🟡",f"text-align:center;")],
]
