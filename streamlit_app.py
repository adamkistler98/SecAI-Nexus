...
# ── KEV TABLE ROWS (full descriptions, no heavy truncation) ──────────────────
kev_rows = []
if kev_recent:
    for v in kev_recent:
        cve = v.get("cveID","N/A")
        ...
        sn = nm[:75] + "…" if len(nm) > 75 else nm          # increased from 40 → 75 so more shows
        kev_rows.append([
...
# ── REVAMPED OWASP LLM TOP 10 (now fully linked like AI charts) ───────────────
owasp_data = [
...
topcves = [[("CVE-2025-55182",f"color:{CYAN};font-weight:bold;"),("React2Shell",f"color:#888;font-size:.56rem;"),("10.0",f"color:{RED};font-weight:bold;"),("RCE · Most targeted",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-53770",f"color:{CYAN};font-weight:bold;"),("MS SharePoint",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("Zero-day RCE",f"color:{GREY};font-size:.56rem;")],[("CVE-2020-1472",f"color:{CYAN};font-weight:bold;"),("MS ZeroLogon",f"color:#888;font-size:.56rem;"),("10.0",f"color:{RED};font-weight:bold;"),("Still #1 persistent",f"color:{GREY};font-size:.56rem;")],[("CVE-2021-44228",f"color:{CYAN};font-weight:bold;"),("Log4Shell",f"color:#888;font-size:.56rem;"),("10.0",f"color:{RED};font-weight:bold;"),("Supply chain",f"color:{GREY};font-size:.56rem;")],[("CVE-2024-3400",f"color:{CYAN};font-weight:bold;"),("Palo Alto PAN-OS",f"color:#888;font-size:.56rem;"),("10.0",f"color:{RED};font-weight:bold;"),("Firewall RCE",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-66516",f"color:{CYAN};font-weight:bold;"),("Apache Tika",f"color:#888;font-size:.56rem;"),("9.8",f"color:{RED};font-weight:bold;"),("XXE/SSRF",f"color:{GREY};font-size:.56rem;")],[("CVE-2024-21887",f"color:{CYAN};font-weight:bold;"),("Ivanti Connect",f"color:#888;font-size:.56rem;"),("9.1",f"color:{RED};font-weight:bold;"),("VPN Auth bypass",f"color:{GREY};font-size:.56rem;")],[("CVE-2025-52691",f"color:{CYAN};font
