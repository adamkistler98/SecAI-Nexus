...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; border-bottom: 2px solid #141420; padding-bottom: 12px; margin-bottom: 20px; margin-top: -50px; gap: 15px;">
  ...
  <div style="flex: 1; min-width: 450px; text-align: left;">
    <div style="display: flex; align-items: baseline; gap: 8px;">
      <span style="font-size: 1.6rem; font-weight: bold; color: {GREEN}; text-shadow: 0 0 15px {GREEN}80; letter-spacing: 1.5px; white-space: nowrap;">
        🤖 SecAI-Nexus
      </span>
      <span style="font-size: 0.95rem; font-weight: bold; color: {CYAN}; text-transform: uppercase; letter-spacing: 1px; text-shadow: 0 0 8px {CYAN}40;">
    ...
    <div style="font-size: .52rem; color: #505060; margin-top: 6px; letter-spacing: 0.5px;">
