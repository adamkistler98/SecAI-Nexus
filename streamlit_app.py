...
def get_fallback_data():
    mock_vulns = ["Kernel Heap Overflow", "MFA Bypass Pattern", "Auth Token Leak", "RCE in API Gateway", "Encrypted Tunnel Injection", "SQLi in Core Auth", "Privilege Escalation", "Memory Corruption"]
