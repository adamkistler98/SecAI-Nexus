...
# ── NEW TOP 15 AI-POWERED CYBERCRIME (2026) ──────────────────────────────────
ai_crime_data = [
    ("1. AI Phishing Campaigns", "https://www.crowdstrike.com/global-threat-report/", "Scaling 400% YoY", "Hyper-personalized spear-phishing with perfect grammar", "CrowdStrike GTR 2026"),
    ("2. Deepfake Vishing", "https://www.ibm.com/reports/data-breach", "442% ↑", "3-second voice cloning for CEO fraud & wire transfers", "IBM Cost of Breach 2026"),
    ("3. Polymorphic AI Malware", "https://www.crowdstrike.com/global-threat-report/", "Evasive", "BlackMamba-style code mutation that bypasses all AV", "CrowdStrike GTR 2026"),
    ("4. Prompt Injection Attacks", "https://owasp.org/www-project-top-10-for-large-language-model-applications/", "#1 LLM risk", "Direct/indirect injection leading to data exfil", "OWASP LLM Top 10"),
    ("5. Automated OSINT & Recon", "https://www.mandiant.com/m-trends", "Automated", "LLM-driven target profiling in minutes", "Mandiant M-Trends 2026"),
    ("6. Model Poisoning (Supply Chain)", "https://atlas.mitre.org/", "Growing", "Backdoored Hugging Face models & training data", "MITRE ATLAS"),
    ("7. Agentic AI Abuse", "https://www.ibm.com/reports/data-breach", "Insider Risk", "Autonomous agents performing unintended actions", "IBM Cost of Breach 2026"),
    ("8. Deepfake Video Fraud", "https://www.chainalysis.com/", "Rising", "Real-time face swaps in video calls ($25M+ scams)", "Chainalysis 2026"),
    ("9. AI PassGAN Cracking", "https://www.darkreading.com/", "51% <60s", "Predictive password cracking at machine speed", "Dark Reading"),
    ("10. Adversarial ML Evasion", "https://www.crowdstrike.com/global-threat-report/", "Emerging", "Pixel perturbations that fool every classifier", "CrowdStrike GTR 2026"),
    ("11. AI-Generated Ransomware", "https://www.sophos.com/en-us/content/state-of-ransomware", "Fastest breakout", "LLMs writing custom encryptors on demand", "Sophos 2026"),
    ("12. Shadow AI Data Leakage", "https://www.ibm.com/reports/data-breach", "20% of breaches", "Rogue LLMs exfiltrating sensitive data", "IBM Cost of Breach 2026"),
    ("13. AI-Driven BEC", "https://www.ic3.gov/AnnualReport", "Deepfake voice", "CEO voice cloning for $137k+ wire fraud", "FBI IC3 2026"),
    ("14. Training Data Poisoning", "https://owasp.org/www-project-top-10-for-large-language-model-applications/", "Backdoor risk", "Corrupted datasets creating hidden triggers", "OWASP LLM Top 10"),
    ("15. AI SOC Evasion", "https://www.mandiant.com/m-trends", "New frontier", "Tricking XDR/SOAR with adversarial prompts", "Mandiant M-Trends 2026")
]
